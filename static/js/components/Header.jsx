  ...
  return (
    <nav style={styles.header}>
      ...
      <div style={styles.buttons}>
        ...
        <button style={styles.button} onClick={() => window.open("https://app.uniswap.org/#/swap?inputCurrency=eth&outputCurrency=0xcomingsoon", "_blank")}>BUY NOW</button>
      ...
      {isMobile && menuOpen && (
        <>
          ...
          <div style={styles.mobileMenu}>
            ...
            <button style={styles.hamburgerButton} onClick={() => window.open("https://app.uniswap.org/#/swap?inputCurrency=eth&outputCurrency=0xcomingsoon", "_blank")}>BUY NOW</button>
          </div>
        </>
      )}
    </nav>
